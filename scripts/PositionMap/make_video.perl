...
mkdir($Tdir) or die "Couldn't make $Tdir";
    ...
    my $Glob = "/Users/philip/LocalData/images/WD/*.png";
    my $Count=0;
...
`ffmpeg  -r 48 -i $Tdir/%04d.png -c:v libx264 -preset slow -tune animation -profile:v high -level 4.1 -pix_fmt yuv420p -crf 22 -c:a copy WD.mp4`;
